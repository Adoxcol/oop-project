 ...
 * @author User
 */
public class ConductCustomerSatisfactionSurveysController implements Initializable {
    ...
    @FXML
    private void customerfeedback(ActionEvent event) {
    }

    @FXML
    private void analyzesurveyresponses(ActionEvent event) {
    }
